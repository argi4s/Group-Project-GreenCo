...
class CameraStream:
    def __init__(self, video_ip="pop-os.local", video_port=5800, vec_port=5801,
                 width=640, height=480, fps=20, detect_every_n=10):
        # Configuration
    ...
    def _run_camera(self):
        ...
        try:
            ...
            while self.running:
                ...
                try:
                    self.vec_sock.sendto(payload, (self.VIDEO_IP, self.VEC_PORT))   # GCS
                    self.vec_sock.sendto(payload, ("127.0.0.1", self.VEC_PORT))     # Pi local
