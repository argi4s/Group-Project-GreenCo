...
TEST_SQUARE = [
    (51.4234248, -2.6713921),
    (51.4232738, -2.6712371),
    (51.4233227, -2.6710807),
    (51.4234691, -2.6712107)
]
...
def handle_event(event, param):
    ...
    if current_state == STATE_FLIGHT:
        ...
        # -------------------------
            ...
            send_status(f"Lawnmower mission with {len(mission_wps)} waypoints", type_="FSM")
        ...
        # -----------------------
            ...
            mission_wps = [(lon, lat, current_alt) for lon, lat, _ in PLB_WPS]
